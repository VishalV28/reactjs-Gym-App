      ...
      <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
        ...
        return (
          <button onClick={()=>{
            ...
            key={typeIndex} className={'bg-slate-950 border  duration-200 px-4 hover:border-blue-600 py-3 rounded-lg ' + (type === split ? ' border-blue-600' : ' border-blue-400')}>
            <p className='capitalize'>{type.replaceAll('_', " ")}</p>
          </button>
        )
        })}
      </div>
      <Header index={'02'} title={'Lock down on Targets'} />
